...
STAR.prototype = {
	...
	init : function(context){
		...
		this.gradient.addColorStop(1, 'hsla(340, 80.40%, 30.00%, 0.00)');
		this.gradient.addColorStop(0.25, 'hsl(167, 79.60%, 48.00%)');
	    this.gradient.addColorStop(0.25, 'hsl(332, 80.40%, 50.00%)');
		this.gradient.addColorStop(1, 'hsla(19, 32.10%, 43.90%, 0.00)');
	},
	render : function(context){
		context.save();
